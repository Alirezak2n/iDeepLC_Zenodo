...
import Zenodo.utilities as utilities
...
Tuple[DataLoader, DataLoader, DataLoader, DataLoader, np.ndarray]]:
    ...
    if eval_type == "20datasets":
        dataset_path = f"20_datasets_evaluation/datasets/{dataset_name}/"
        ...
        dataset_path = f"PTM_evaluation/ptm_datasets/{dataset_name}/"
        train_x = np.load(dataset_path + 'train_x.npy')
        train_y = np.load(dataset_path + 'train_y.npy')
        val_x = np.load(dataset_path + 'val_x.npy')
        val_y = np.load(dataset_path + 'val_y.npy')
        ...
        dataset_path = f"modified_glycine_evaluation/aa_glycine_datasets/{dataset_name}_{test_aa}_"
